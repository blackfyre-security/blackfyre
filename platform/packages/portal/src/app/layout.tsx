...
import { ToastProvider, ErrorBoundary, ThemeProvider, themeScript } from "@blackfyre/ui";
...
export const metadata: Metadata = {
  title: "BLACKFYRE",
  description: "AI Security & Compliance Platform",
};
    ...
    <html lang="en" className={`${jakarta.variable} ${mono.variable}`} suppressHydrationWarning>
      <body className="font-sans antialiased">
        ...
        <ThemeProvider>
          <ErrorBoundary>
            <AuthProvider>
              <ToastProvider><main id="main-content">{children}</main></ToastProvider>
            </AuthProvider>
          </ErrorBoundary>
        </ThemeProvider>
      </body>
